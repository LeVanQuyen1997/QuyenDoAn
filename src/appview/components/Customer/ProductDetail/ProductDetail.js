                                ...
                                <div className="col-md-8">
                                    <div className="row">
                                        <div className="col-md-5">
                                            <img src="./src/public/img/product.png" width="100%"/>
                                        </div>
                                        <div className="col-md-7">
                                            <h5>Combo 10 viên giặt cầu gai hỗ trợ giặt quần áo sạch hơn trong máy giặt</h5>
                                            ...
                                            <div className="product_detail_brand">
                                                <span>Thương hiệu :</span><Link to="" className="item">No Brand</Link>
                                            </div>
                                            <hr/>
                                ...
                                <div className="col-md-4 ">
                                    <div className="product_detail_right">
                                        ...
                                        <div className="map">
                                            ...
                                            <Link to="" className="item">THAY ĐỔI</Link>
                                        </div>
                                        <div>
                                            <div>
                                        ...
                                        <div className="link_store">
                                            <h4><Link to="/" className="item">Đến Gian Hàng</Link></h4>
                                        </div>
                                    </div>
